...
jQuery(document).ready(function($) {
	...
	$(document).ready(function() {
		...
		$('.grid-item').click(function() {
			$(this).children('.port-panel').addClass('reveal');
			$('html').addClass('fixed');
		});
		
		$('.close').click(function(e) {
			e.stopPropagation();
			$('.port-panel, .bio-container-wrap').removeClass('reveal');
			$('html').removeClass('fixed');
		});
		
		$('.bio').click(function() {
			$(this).parent().next().addClass('reveal');
			$('html').addClass('fixed');
		});
	...
	var idPlayer1 = new Vimeo.Player('video-frame-1');
	var idPlayer2 = new Vimeo.Player('video-frame-2');
	var idPlayer3 = new Vimeo.Player('video-frame-3');
	var idPlayer4 = new Vimeo.Player('video-frame-4');
	var idPlayer5 = new Vimeo.Player('video-frame-5');
	var idPlayer6 = new Vimeo.Player('video-frame-6');
	var idPlayer7 = new Vimeo.Player('video-frame-7');
    ...
    idPlayer2.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer2.pause();
            }else{
    ...
    idPlayer3.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer3.pause();
            }else{
    ...
    idPlayer4.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer4.pause();
            }else{
    ...
    idPlayer5.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer5.pause();
            }else{
    ...
    idPlayer7.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer7.pause();
            }else{
    ...
    idPlayer8.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer8.pause();
            }else{
    ...
    idPlayer9.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer9.pause();
            }else{
    ...
    idPlayer10.getPlayed().then(function(played) {
        $('.slick-prev, .slick-next, .slick-dots li').click(function() {
            if(played){
                idPlayer10.pause();
            }else{
	...
	idPlayer15.getPlayed().then(function(played) {
	    $('.slick-prev, .slick-next, .slick-dots li').click(function() {
	        if(played){
				idPlayer15.pause();
	        } else {
	...
	idPlayer16.getPlayed().then(function(played) {
	    $('.slick-prev, .slick-next, .slick-dots li').click(function() {
	        if(played){
	            idPlayer16.pause();
	        } else {
